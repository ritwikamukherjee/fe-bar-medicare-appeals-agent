...
CATALOG = os.environ.get("CATALOG", "hls_amer_catalog")
SCHEMA_NAME = os.environ.get("SCHEMA", "appeals-review")
# Backtick both to tolerate dashes or reserved words in either identifier.
SCHEMA = f"`{CATALOG}`.`{SCHEMA_NAME}`"
DASHBOARD_URL = os.environ.get(
    "DASHBOARD_URL",
    "https://fe-vm-hls-amer.cloud.databricks.com/dashboardsv3/01f13f533fd910698aa393a23af4b390/published?isDbOne=true&utm_source=databricks-one&o=1602460480284688",
)
